...
let githubLink = "https://github.com/eerohele/equis"

// Specify more information about your project
let info =
  [ "project-name", "Equis"
    "project-author", "Eero Helenius"
    "project-summary", "Execute an XSLT transformation when either the stylesheet or source files change."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Equis" ]
