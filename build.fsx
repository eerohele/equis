...
let summary = "Execute an XSLT transformation when either the stylesheet or source files change."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Execute an XSLT transformation when either the stylesheet or source files change."
...
let solutionFile  = "Equis.sln"

// Default target configuration
let configuration = "Release"

// Pattern specifying assemblies to be tested using Expecto
let testExecutables = "tests/**/bin" </> configuration </> "*Tests*.exe"
